...
public class MenuController {
    ...
    public String addItem(@ModelAttribute @Valid AddMenuItemForm newAddMenuItemForm, Errors errors,
                      Model model){
        ...
        menu.addItem(cheeseDao.findOne(newAddMenuItemForm.getCheeseId()));
        menuDao.save(menu);
